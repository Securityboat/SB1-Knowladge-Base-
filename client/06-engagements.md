...
|-------|------------------|:---:|
| **Requested** | You submitted a request; awaiting SBOne review. | ✅ |
...
> engagement — scope, testers, and scheduling need SBOne review. So clients file a
> **request** (a `Requested` engagement); once SBOne approves it, it becomes a
...
| **Preferred start** | Date | — | — | Approximate is fine — SBOne confirms the real schedule. |
| **Preferred end** | Date | — | — | Your target window close. |

**What happens after you submit:**

1. **Review** — SBOne reviews scope and feasibility (typically within 1 business day).
...
> scoping details before SBOne moves it into Scoping.
