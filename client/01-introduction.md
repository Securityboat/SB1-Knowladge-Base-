...
**SecurityBoatOne (SBOne)** is the security platform your organisation uses to run
...
### What you can do on SBOne (client modules)
...
Each chapter covers one module in depth: what it's for, how to reach it, every
on-screen control, the end-to-end flow, and what your role can and can't do. Start
with **Login** to sign in, then your **Dashboard**.
