...
Welcome to **SecurityBoatOne (SBOne)**. This Getting Started guide helps client users quickly understand their workspace, navigation, role permissions, and key workflows without needing to reference internal administrative documentation.

---

## 1. What SecurityBoatOne is for Clients

SecurityBoatOne is your central security portal. Instead of managing security reports via static emails or PDFs, you use SecurityBoat to:
